...
const ProviderRidestatement = () => {
  ...
  const fetchUsers = async (page = 1, size = pageSize) => {
    try {
      const response = await fetch(`http://localhost:8000/api/users/providerridessatement/${id}?page=${page}&limit=${size}`);
              ...
              <>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <div className="d-flex">
                    ...
                    <Button
                      onClick={() => navigate('/Statement/ProviderStatement')}
...
export default ProviderRidestatement;
