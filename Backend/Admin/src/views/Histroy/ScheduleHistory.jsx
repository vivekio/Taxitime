...
const ScheduleHistory = () => {
  ...
  const fetchUsers = async (page = 1, size = pageSize) => {
    try {
      const response = await fetch(`http://localhost:8000/api/users/getscheduledhistory?page=${page}&limit=${size}`);
                ...
                <>
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div className="d-flex">
                      ...
                      <Button onClick={() => navigate('/Histroy/RequestHistory')} className="btn-dark">
                        REQUEST HISTORY
                      </Button>
                    </div>
                  </div>
